public class Universe {
    public static void main(String[] args) {
        ...
        long poblacion = 8_118_302_456L;


        //Imprime el resultado final
        System.out.println("La población mundial actual es de " + poblacion + " habitantes.");


        //La vía láctea parece tener unos cuatrocientos mil millones de estrellas, crea una variable con esa cantidad.

        long vlStars = 400_000_000_000L;
       ...
       long andromedaStars = 1_000_000_000L;
        ...
        System.out.println("Hay " + vlStars + andromedaStars + " de estrellas en Andrómeda y en la Vía Láctea juntas.");
